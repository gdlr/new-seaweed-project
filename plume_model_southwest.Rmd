...
points <- read_sf(here("new_data", "GIS_output", "nitrogen"), layer = "southwest_snapjoin")%>%
  select("CumAreaKm2", "al_tn", "geometry")

crs(points)

phosphorous <- read_sf(here("new_data", "GIS_output", "phosphorous"), layer = "southwest_snapjoinP")%>%
...
```{r}
path <- here("plume_outputs", "southwest_tp")
